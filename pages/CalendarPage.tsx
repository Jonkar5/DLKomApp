  ...
  return (
    <div className="h-full flex flex-col animate-fade-in pb-4">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 overflow-hidden min-h-0">
        ...
        <div className="lg:w-[70%] bg-white rounded-3xl shadow-sm border border-slate-200 flex flex-col overflow-hidden h-full">
              ...
              {Array.from({ length: getDaysInMonth(currentDate) }).map((_, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {eventDot && (
                      <span className={`absolute bottom-2 w-1.5 h-1.5 rounded-full ${today ? 'bg-white' : 'bg-indigo-500'}`}></span>
                    )}
                  </button>
                );
              })}
        ...
        <div className="lg:w-[30%] flex flex-col h-full bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                   ...
                   <div className="grid grid-cols-3 gap-2">
                      {['meeting', 'call', 'deadline'].map(type => (
                        <button
                          ...
                          className={`py-2 rounded-lg text-sm font-bold capitalize transition-all border ${
                            formData.type === type 
